...
(function(){
  ...
  const devFor = {
    'eversolar_legacy-EU00T112345678':{id:'eversolar_legacy-EU00T112345678',label:'Schuur',
    ...
    'growatt_modbus-GW2400ABC':{id:'growatt_modbus-GW2400ABC',label:'Garage',
      ...
      consecutive_poll_failures:0},
    'growatt_modbus-GW3300XYZ':{id:'growatt_modbus-GW3300XYZ',label:'Dak achter',
