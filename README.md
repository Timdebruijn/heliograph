...
| Sofar Solar HYD 5…20K-3PH (three phase, hybrid) | Modbus RTU over RS485 | **Experimental** — shares the EP map and adds phases L2/L3. What it shares is two-sourced; **the two extra phases are vendor-document only**, because the hardware behind the second source is single-phase. See [docs/sofar-hyd-protocol.md](docs/sofar-hyd-protocol.md) |
