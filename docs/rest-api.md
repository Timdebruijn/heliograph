...
Server: **ESP32Async/ESPAsyncWebServer 3.12.1** (LGPL-3.0) + AsyncTCP 3.5.0.
...
```json
{
  ...
  "modbus": { "enabled": true, "port": 502, "unit_id": 1, "max_clients": 4,
              "idle_timeout_seconds": 20, "write_enabled": false },
